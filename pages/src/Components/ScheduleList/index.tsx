...
import { ScheduleListMock } from '../../../_mocks_/ScheduleListMock';
...
export const ScheduleList = ({timeList, fullDate, local, quadra}: ScheduleListProps) => {
  ...
  const [scheduleList, setScheduleList] = useState(ScheduleListMock.horarios)
  ...
  useEffect(() => {
    ...
    const maxTime = 22 - timeNow
    const listTime = []
    for(let i= 1; i<maxTime; i++){
      listTime.push(timeNow+i)
    }
    setListTime(listTime)
    setTimeNow(timeNow)
  }, [scheduledTimeList, timeList])
